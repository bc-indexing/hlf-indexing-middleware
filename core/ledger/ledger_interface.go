...
type HistoryQueryExecutor interface {
	...
	GetHistoryForKeyRange(namespace string, keys []string) (commonledger.ResultsIterator, error)
	GetHistoryForVersionRange(namespace string, key string, start uint64, end uint64) (commonledger.ResultsIterator, error)
	GetHistoryForBlockRange(namespace string, start uint64, end uint64, updates uint64) (commonledger.ResultsIterator, error)
}
